                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full dark:text-slate-400 h-12 pl-11 pr-4 rounded-xl border border-slate-300 dark:border-slate-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
